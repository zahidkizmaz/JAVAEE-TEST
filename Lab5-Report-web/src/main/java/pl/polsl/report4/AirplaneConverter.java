...
/**
 *
 * @author Raul Hernandez - Zahid Kizmaz - Grande Alvaro
 * @version 1.0
 */
public class AirplaneConverter implements Converter{
    ...
    private static Report3SesionBeanLocal lookup(){
        try {
            ...
            return (Report3SesionBeanLocal) context.lookup("java:global/Lab5-Report-ear/Lab5-Report-ejb-1.0/Report3SesionBean!pl.polsl.report2.Report3SesionBeanLocal");
